...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('forntend/assets/images/logo/favourite_icon_1.png')}}">

    <!-- fraimwork - css include -->
    <link rel="stylesheet" type="text/css" href="{{ asset('forntend/assets/css/bootstrap.min.css') }}">

    <!-- icon font - css include -->
    <link rel="stylesheet" type="text/css" href="{{ asset('forntend/assets/css/fontawesome.css')}}">
    <link rel="stylesheet" type="text/css" href="{{ asset('forntend/assets/css/stroke-gap-icons.css')}}">
    <link rel="stylesheet" type="text/css" href="{{ asset('forntend/assets/css/icofont.css')}}">
    ...
    <!-- popup - css include -->
    <link rel="stylesheet" type="text/css" href="{{ asset('forntend/assets/css/magnific-popup.css')}}">

    <!-- jquery-ui - css include -->
    <link rel="stylesheet" type="text/css" href="{{ asset('forntend/assets/css/jquery-ui.css')}}">

    <!-- select option - css include -->
    <link rel="stylesheet" type="text/css" href="{{ asset('forntend/assets/css/nice-select.css')}}">

    <!-- woocommercen - css include -->
    <link rel="stylesheet" type="text/css" href="{{ asset('forntend/assets/css/woocommerce.css')}}">
...
<body>
                            ...
                            <ul class="header_select_options ul_li">
                                <li>
                                    <div class="select_option">
                                        <div class="flug_wrap">
                                            <img src="{{ asset('forntend/assets/images/flug/flug_uk.png')}}" alt="image_not_found">
                                        </div>
                                        <select>
                    ...
                    <div class="row align-items-center">
                        <div class="col col-lg-3 col-md-3 col-sm-12">
                            <div class="brand_logo">
                                <a class="brand_link" href="{{ route('forntend.home') }}">
                                    <img src="{{ asset('forntend/assets/images/logo/logo_1x.png')}}" srcset="{{ asset('forntend/assets/images/logo/logo_2x.png')}} 2x" alt>
                                </a>
                            </div>
                        </div>
                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col col-md-3">
                            <div class="allcategories_dropdown">
                                ...
                                <div class="{{ Request()->routeIs('forntend.home') ? "show" :"collapse"}}" id="allcategories_collapse">
                                    <div class="card card-body">
                                    @foreach (App\Models\Category::all() as $category )
                                    <ul class="allcategories_list ul_li_block">
                                        <li><a href="shop_grid.html"><i class="icon icon-Starship"></i>{{$category->name}}</a></li>
                                    </ul>
                                    @endforeach
                            ...
                            <nav class="main_menu navbar navbar-expand-lg">
                                <div class="main_menu_inner collapse navbar-collapse" id="main_menu_dropdown">
                                    ...
                                    <ul class="main_menu_list ul_li">
                                        ...
                                        <li><a class="nav-link" href="{{route('forntend.user.shop')}}">Shop</a></li>
                    ...
                    <div class="col col-md-3">
                        <ul class="header_icons_group ul_li_right">
                             @auth()
                             <li>
                                <a href="{{ route('forntend.user.dashboard') }}">{{ auth()->user()->name}}</a>
                            </li>

                            <li>
                                <a href="{{route('forntend.user.register')}}">
                             ...
                             @guest()
                             <li>
                                <a href="{{route('forntend.user.register')}}">SING IN</a>
                             </li>
                             <li>
                                <svg role="img" xmlns="http://www.w3.org/2000/svg" width="30px" height="30px" viewBox="0 0 24 24" stroke="#051d43" stroke-width="1" stroke-linecap="square" stroke-linejoin="miter" fill="none" color="#2329D6"> <title id="personIconTitle">Person</title> <path d="M4,20 C4,17 8,17 10,15 C11,14 8,14 8,9 C8,5.667 9.333,4 12,4 C14.667,4 16,5.667 16,9 C16,14 13,14 14,15 C16,17 20,17 20,20"/> </svg>
                             </li>
                            ...
                            <div class="footer_widget footer_about">
                                <div class="brand_logo">
                                    <a class="brand_link" href="index.html">
                                        <img src="{{ asset('forntend/assets/images/logo/logo_1x.png')}}" alt="logo_not_found">
                                    </a>
                                </div>
                        ...
                        <div class="col col-lg-4 col-md-6 col-sm-6">
                            <div class="footer_widget footer_contact">
                                ...
                                <ul class="store_btns_group ul_li">
                                    <li><a href="#!"><img src="{{ asset('forntend/assets/images/app_store.png')}}" alt="app_store"></a></li>
                                    <li><a href="#!"><img src="{{ asset('forntend/assets/images/play_store.png')}}" alt="play_store"></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col col-md-6">
                            <div class="payment_method">
                                <h4>Payment:</h4>
                                <img src="{{ asset('forntend/assets/images/payments_icon.png')}}" alt="image_not_found">
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script src="{{ asset('forntend/assets/js/jquery-plugins-collection.js')}}"></script>

    <!-- google map  -->
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDk2HrmqE4sWSei0XdKGbOMOHN3Mm2Bf-M&ver=2.1.6"></script>
    <script src="{{ asset('forntend/assets/js/gmaps.min.js')}}"></script>
