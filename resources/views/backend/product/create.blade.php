            ...
            <div class="x_content">
                ...
                <form action="{{route('backend.product.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row col-md-12 ">
                        ...
                        <div class="col-md-12 col-sm-12">
                               <textarea name="discription" class="form-control summernote">{{ old('discription') }}</textarea>
                        </div>
                    </div>
                    <div class="form-group row col-md-12 ">
                        <label for="parent" class="col-md-12"><h2>Short Discription</h2></label>
                        <div class="col-md-12 col-sm-12">
                               <textarea name="short_discription" class="form-control summernote">{{ old('short_discription') }}</textarea>
                        </div>
                    </div>
                    <div class="form-group row col-md-12 ">
                        <label for="parent" class="col-md-12"><h2>Additional_Info</h2></label>
                        <div class="col-md-12 col-sm-12">
                               <textarea name="additional_info" class="form-control summernote">{{ old('additional_info') }}</textarea>
                        </div>
                    </div>
                    <div class="form-group col-md-12 ">
